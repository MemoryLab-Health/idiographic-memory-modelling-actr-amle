...
Export the greedy-selection AIC plot one step at a time, each cumulative:
step 1 shows only the first winner, step 2 reveals steps 1–2, etc. The x-axis
and y-axis are fixed to the full-data range so nothing jumps between slides.

```{r stepwise-aic, message=FALSE, warning=FALSE}
