...
Export panels A (recovery vs. repetitions) and C (recovery vs. facts) in five cumulative
steps, adding one parameter at a time in the canonical order used throughout the paper:
φ → τ → s → F → t_er. Each step is saved as both PNG and SVG.

```{r stepwise-recovery, message=FALSE, warning=FALSE}
